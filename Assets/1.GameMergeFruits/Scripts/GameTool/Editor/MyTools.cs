...
public class MyTools
{
    ...
    //[MenuItem("MyTools/AddEveryThingtoPrefabs")]
    //static void Add()
    //{
    //    foreach(MeshRenderer mesh in Selection.gameObjects[0].GetComponentsInChildren<MeshRenderer>())
    //    {
    //        mesh.gameObject.AddComponent<MeshCollider>().convex = true;
    //        mesh.gameObject.AddComponent<Rigidbody>().collisionDetectionMode = CollisionDetectionMode.ContinuousDynamic;
    //        mesh.gameObject.AddComponent<SelectingObjectiles>();
    //    }
    //    foreach(SkinnedMeshRenderer skinmesh in Selection.gameObjects[0].GetComponentsInChildren<SkinnedMeshRenderer>())
    //    {
    //        skinmesh.gameObject.AddComponent<MeshCollider>().convex = true;
    //        skinmesh.gameObject.AddComponent<Rigidbody>().collisionDetectionMode = CollisionDetectionMode.ContinuousDynamic;
    //        skinmesh.gameObject.AddComponent<SelectingObjectiles>();
    //    }
    //}
    ...
    [MenuItem("MyTools/AddScriptToPrefabs")]
    private static void AddSelectingObject()
    {
